...
%% Set specifications for estimation and simulation
...
[cfvalue_theta_initial,g_sT_theta_initial,test1] = msm_cf(seedstate,theta_initial,sT,EM,W,expectationshock,constant_2,n);
...
test2 = msm_g_st(seedstate,theta_hat,sT,EM,expectationshock,constant_2,n);
