function [stats_returns,stats_pdratio,stats_predictability,stats_macro,stats_errors,stats_moments,stats_prediction_errors] = msm_model(n,T,burn,parameters,seedstate)
...
for i = 1:n
    ...
    %state
    [allvariables,pf_totaltimes,pf_engaged,R1test,R2test] = lom_learn_cg(a,b,ro,G,P,Mbar1,Mbar2,P_0,Z_0,shock,mu,T,gain,eshock,eshock_wn,constant_2);
